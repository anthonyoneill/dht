...
\input{./sections/discrete_calculus.tex}

\input{./sections/component_networks.tex}

\input{./sections/steady/steady_state_solver.tex}

\input{./sections/transient/transient_solver.tex}
